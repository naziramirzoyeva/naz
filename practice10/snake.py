...
#настройки экрана
CELL       = 20          # одна клетка сколько пикселей
COLS, ROWS = 30, 25      # сколько строк и столбиков
HUD_H      = 50          # высота панели

SCREEN_W = CELL * COLS
SCREEN_H = CELL * ROWS + HUD_H

BASE_FPS        = 8      # движений в сек у змеи 1 лвл
FPS_PER_LEVEL   = 2      # добавление скорости за лвл
FOODS_PER_LEVEL = 3      # 3 сьедания чтоб +лвл был
